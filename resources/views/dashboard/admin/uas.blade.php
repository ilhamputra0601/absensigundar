    ...
    <main id="main" class="main">
        ...
        <div class="card info-card ">
            ...
            <div class="card-body">
                ...
                <form action="">
                    <h5 class="card-title">Olah Data Absensi M14</h5>
                ...
                <form action="">
                    <label class="form-label">Proses List UAS Perkelas</label>
                    <div class="progress mb-3" role="progressbar" aria-label="Animated striped example" aria-valuenow="75"
                        aria-valuemin="0" aria-valuemax="100">
                        <div class="progress-bar progress-bar-striped progress-bar-animated" style="width: 75%"></div>
                    </div>
                ...
                <form action="">
                    <label class="form-label">Upload Kartu UAS ke Laman Mahasiswa </label>
